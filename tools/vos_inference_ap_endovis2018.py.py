...
def main():
    ...
    parser.add_argument(
        "--sam2_checkpoint",
        type=str,
        default= "/home/gxu/proj1/lesionSeg/utswtumor_track/SurgSAM2_Mem/sam2_logs/sim_surgsam2_ts_ms_prune_ssim_sp_v2/checkpoints/checkpoint.pt", # "./checkpoints/sam2.1_hiera_small.pt", "./sam2_logs/surgsam2_ori/checkpoints/checkpoint_30.pt"
        help="path to the SAM 2 model checkpoint",
    )
    parser.add_argument(
        "--output_mask_dir",
        type=str,
        default="/home/gxu/proj1/lesionSeg/utswtumor_track/SurgSAM2_Mem/sam2_logs/sim_surgsam2_ts_ms_prune_ssim_sp_v2/results",
        help="directory to save the output masks (as PNG files)",
    )
    parser.add_argument(
        "--base_video_dir",
        type=str,
        default="/home/gxu/proj1/lesionSeg/utswtumor_track/SurgSAM2_Mem/datasets/VOS-Endovis18/valid/JPEGImages",
        help="directory containing videos (as JPEG files) to run VOS prediction on",
    )
    parser.add_argument(
        "--input_mask_dir",
        type=str,
        default="/home/gxu/proj1/lesionSeg/utswtumor_track/SurgSAM2_Mem/datasets/VOS-Endovis18/valid/VOS/Annotations_vos_instrument",
    ...
    parser.add_argument(
        "--gt_root",
        default="/home/gxu/proj1/lesionSeg/utswtumor_track/SurgSAM2_Mem/datasets/VOS-Endovis18/valid/Annotations",
