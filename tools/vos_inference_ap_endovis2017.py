...
def main():
    ...
    parser.add_argument(
        ...
        # default= "./checkpoints/sam2.1_hiera_small.pt", # "./checkpoints/sam2.1_hiera_small.pt", "./sam2_logs/surgsam2_ori/checkpoints/checkpoint_30.pt"
    ...
    parser.add_argument(
        "--output_mask_dir",
        type=str,
        default="/home/gxu/proj1/lesionSeg/utswtumor_track/SurgSAM2_Mem/sam2_logs/endovis2017_surgsam2_ts_ms_prune_cosine_sp/results",
