...
video_dir = "/home/gxu/proj1/lesionSeg/utswtumor_track/SurgSAM2_Mem/datasets/VOS-Endovis18/valid/JPEGImages/seq_2"
...
points = np.array([[1100, 350]], dtype=np.float32)
