...
def main(args) -> None:
    ...
    cfg["trainer"]["model"]["prune_sim"] = args.sim
    cfg.launcher.experiment_log_dir = cfg.launcher.experiment_log_dir.split("prune")[0]+"prune_"+args.sim
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        # required=True,
        type=str,
        default="configs/sam2.1_training/sam2.1_hiera_s_endovis18_instrument_ts",
    ...
    # similariy = ["euclidean_similarity_sp", "dot_product_similarity_sp", "spearman_rank_correlation_sp",
    #              "pearson_correlation_sp", "manhattan_similarity_sp", "spatial_similarity_sp", 
    #               ]
    
    similariy = ["ssim_sp","cosine_sp", ] # "euclidean_sp", "dot_sp", "spearman_sp", "manhattan_sp", "spatial_sp", "pearson_sp", ssim_sp, "cosine_sp", 
    for sim in similariy:
        args.sim = sim
        main(args)
